...
$sqlPacientes= " SELECT * FROM bancos WHERE Id=$id";
...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="../php/actualizar_banco.php">
                ...
                <a href="../admin/bancos.php" class="btn btn-danger me-2">CANCELAR</a>
            </form>
        </div>
    </div>
</div>