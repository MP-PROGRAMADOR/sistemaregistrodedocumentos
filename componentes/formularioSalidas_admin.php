...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        ...
        <div class="row">
            ...
            <form class="forms-sample" method="POST" action="../php/guardar_salidas_admin.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="archivo" name="archivo" placeholder="Ejemplo solicitud de..." required>
                </div>
