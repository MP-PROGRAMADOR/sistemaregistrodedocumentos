                    ...
                    <tbody>
                        ...
                        <?php while ($row_entradas = $entradas->fetch_assoc()) {  ?>
                            ...
                            <tr>
                                ...
                                <td> <a class="btn btn-primary me-2" href="../entradas/<?= $row_entradas['Archivo']; ?>" download="Entrada-<?= $row_entradas['NumRegistro']; ?>"><i class="mdi mdi-download"></i></a></td>
                                <td>
                                ...
                                <td>
                                    <a class="btn btn-warning me-2" href="../admin/editarInstitucion.php?id=<?php echo $row_entradas['Id']; ?>" class="btn btn-sm btn-warning"><i class="mdi mdi-pencil"></i></a>
                                </td>
                                <td>
